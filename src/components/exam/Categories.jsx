    ...
    return (
        <div className="container mx-auto md:px-16 px-4">
            <div className="w-full text-center h-100 md:mt-24 mt-12">
                ...
                <h1 className="text-2xl md:text-[44px] font-bold md:mt-8 mt-4">{t('categories.titles.title')}</h1>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:w-2/3 my-12 md:mx-auto ms-4">
